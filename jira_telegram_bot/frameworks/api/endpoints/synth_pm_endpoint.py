...
class SynthPMEndpoint(ServiceAPIEndpointBluePrint):
    ...
    def create_rest_api_route(self) -> APIRouter:
        ...
        async def sync_developer_board_features():
            ...
            try:
                result = await self.synth_developer_board_use_case.sync_developer_board_features()
        ...
        async def jira_webhook(request: Request):
            ...
            try:
                ...
                result = await self.synth_developer_board_use_case.handle_jira_webhook(webhook_data)
                return JSONResponse(content=result)
        ...
        async def sheet_update(request: Request):
            ...
            try:
                ...
                if not row_number:
                    raise HTTPException(status_code=400, detail="Row number is required")
