...
WORKLOG_SAVING = "⏳ در حال ثبت در جیرا..."
WORKLOG_ALREADY_SAVED = "این گزارش قبلاً ثبت شده است."
...
# ── voice messages ───────────────────────────────────
VOICE_TRANSCRIBING = "🎧 در حال گوش دادن..."
VOICE_HEARD = "🎧 شنیدم:\n«{text}»"
VOICE_FAILED = (
    "صدا را نتوانستم تبدیل کنم. لطفاً دوباره بفرستید یا همان را بنویسید."
)
VOICE_UNAVAILABLE = (
    "الان نمی‌توانم پیام صوتی را پردازش کنم. لطفاً متن بفرستید."
)

WORKLOG_YOUR_TASKS = "تسک‌های باز شما:"
WORKLOG_MORE_TASKS = "و {count} تسک دیگر."
WORKLOG_KEY_INVALID = (
    "کلید تسک را به این شکل بنویسید: PARSCHAT-123\n"
    "یا اگر تسکی برایش ثبت نشده، «⏭ رد کن» را بزنید."
)
WORKLOG_KEY_NOT_YOURS = (
    "«{issue_key}» بین تسک‌های باز شما نیست. "
    "اگر مطمئنید، اول آن را در جیرا به خودتان اختصاص دهید."
)
