...
Environment Variables:
    DEADLINE_NOTIFIER_CRON: Cron schedule (default: "0 9 * * *" - daily at 9 AM)
...
async def main():
    ...
    parser.add_argument(
        "--cron",
        default=os.environ.get("DEADLINE_NOTIFIER_CRON", "0 9 * * *"),
        help="Cron schedule expression (default: daily at 9 AM)"
    )
    parser.add_argument(
        "--lookahead-days",
        type=int,
