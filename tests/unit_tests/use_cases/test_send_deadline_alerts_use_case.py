...
class TestSendDeadlineAlertsUseCase(unittest.IsolatedAsyncioTestCase):
    ...
    def setUp(self):
        ...
        self.calendar_repository = AsyncMock()  # Calendar repository (async)
        self.deadline_notifier_settings = Mock()  # Settings mock
        self.deadline_notifier_settings.GROUP_NOTIFICATION_USERNAMES = (
            []
        )  # Make iterable
        ...
        self.use_case = SendDeadlineAlertsUseCase(
            ...
            deadline_notifier_settings=self.deadline_notifier_settings,
        )
    ...
    def _create_mock_issue(
        ...
        # Set up issue type
        issuetype_mock = MagicMock()
        issuetype_mock.name = "Story"  # Default issue type
        fields_mock.issuetype = issuetype_mock

        # Set up sprint field (customfield_10020) with active sprint
        fields_mock.customfield_10020 = [
            "com.atlassian.greenhopper.service.sprint.Sprint@1[id=123,rapidViewId=1,state=ACTIVE,name=Sprint 1,goal=<null>]",
        ]
    ...
    async def test_execute_no_issues_found(self):
        ...
        # Arrange
        self.calendar_repository.is_holiday_or_weekend.return_value = (
            False  # Don't skip notifications
        )
